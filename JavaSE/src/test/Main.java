...
public class Main{
    ...
    private static void operation(Deque<Integer> stack, char ch) {
    }

    public static void operation16(Deque<Integer> stack,char c){
        if(stack.isEmpty()){
            return;
        }
        int a=stack.pop();
    ...
    public static void main15(String[] args) {
        int nums1=123;
        int nums2=234;
        int ret=new test.Main().Add(nums1,nums2);
